<template>
    <div class="container has-text-centered">
        <h2 class="title is-size-2">ACNL Modding Info</h2>
        ...
        <p>A link to the project can be found here: <a href="https://acnl-modding.netlify.com/" target="_blank">ACNL Modding Info</a></p>
...
export default {
  data () {
    return {
      title: 'ACNL Modding Info - Projects - Jazmine Nichols'
    }
  },
  head () {
    return {
